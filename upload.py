# -*- coding: utf-8 -*-
"""
Created on Fri Jan  5 10:46:54 2018

@author: JT
"""

"""
Backs up file to Dropbox.
API v2.
"""
...
# OAuth2 access token
TOKEN = 'oCbo9iVsIocAAAAAAAA6viRsl2GT5t9hAD-JNE35bPExVYvwmuRwbG-ugc-kNpLs'

# Ej 'archivo.txt'
LOCALFILE = sys.argv[1] 
DROPBOXPATH = sys.argv[2]  
BACKUPPATH = DROPBOXPATH + '/' + LOCALFILE

# Uploads de un LOCALFILE a Dropbox
def backup():
